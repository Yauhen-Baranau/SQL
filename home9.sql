...
log_type SET("DELETE", "UPDATE", "INSERT") NOT NULL,
table_name VARCHAR(50) NOT NULL,
teacher_id INT NOT NULL
);

START TRANSACTION;
INSERT teachers (fio, lead_class_id ) VALUES("ФЕЛЬГИН ВЛАДИМИР МОИСЕЕВИЧ", 1);
INSERT INTO log_table(log_type, table_name, teacher_id) VALUES("INSERT", "teachers", (SELECT LAST_INSERT_ID()));
COMMIT;
